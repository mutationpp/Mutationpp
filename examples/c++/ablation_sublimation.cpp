...
int main() {
    ...
    std::cout << "@todo CHECK RATES OF SUBLIMATION!" << std::endl;

    Mutation::MixtureOptions opts("O2_N2_C_ablation");
    ...
    const int iC3  = mix.speciesIndex("C3");
...
// Conditions T = 3000K and p = 100Pa
    ...
    v_rhoi[iC3] = 1.00000e-10;
    double total_rho = v_rhoi[iO] + v_rhoi[iN] + v_rhoi[iO2] + v_rhoi[iCO] + v_rhoi[iCN] + v_rhoi[iC3];
    wall_temperature = 3000.e0;
    ...
    std::cout << "The result for the partial densities are: " << v_rhoi[0] << " " << v_rhoi[1] << " " << v_rhoi[2] 
              << " " << v_rhoi[3] << " " << v_rhoi[4] << " " << v_rhoi[5] << std::endl;

//================================================================================================================

    total_rho = v_rhoi[iO] + v_rhoi[iN] + v_rhoi[iO2] + v_rhoi[iCO] + v_rhoi[iCN] + v_rhoi[iC3];
    ...
    std::cout << "The wall production rates are: " << v_wall_production_rates[0] << " " 
              ...
              << v_wall_production_rates[3] << " " << v_wall_production_rates[4] << " "
              << v_wall_production_rates[5] << std::endl;
    ...
    std::cout << "The residual is equal to: " << v_function[0] << " " << v_function[1] 
              << " " << v_function[2] << " " << v_function[3] << " " << v_function[4] 
              << " " << v_function[5] << std::endl;
