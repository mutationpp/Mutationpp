...
void init_MixtureOptions(py::module &m)
{
	/**
	...
	py::class_<Mutation::MixtureOptions>(m, "MixtureOptions")
        ...
        .def("loadFromFile",
            &Mutation::MixtureOptions::loadFromFile)
        .def("loadFromXmlElement",
            &Mutation::MixtureOptions::loadFromXmlElement)
		.def("getSource",
		...
		.def(py::init<std::string &>())
		.def("nElements",
		    &Mutation::Mixture::nElements,
		    "Returns the number of elements considered in the mixture."
		    )

		.def("nAtoms",
		    &Mutation::Mixture::nAtoms,
		    "Returns the number of atomic species in the mixture."
		    )

		.def("nMolecules",
		    &Mutation::Mixture::nMolecules,
		    "Returns the number of molecules in the mixture."
		    )

		.def("nHeavy",
		    &Mutation::Mixture::nHeavy,
		    "Returns the number of heavy particles (non electrons) in the mixture."
		    )

		.def("nSpecies",
		    &Mutation::Mixture::nSpecies,
		    "Returns the number of species considered in the mixture."
		    )

		.def("nPhases",
		    &Mutation::Mixture::nPhases,
		    "Returns the number of phases belonging to this mixture."
		    )

		.def("nGas",
		    &Mutation::Mixture::nGas,
		    "Returns number of gas species in the mixture."
		    )

		.def("nCondensed",
		    &Mutation::Mixture::nCondensed,
		    "Returns the number of condensed phase species in the mixture."
		    )

		.def("nEnergyEqns",
		    &Mutation::Mixture::nEnergyEqns,
		    "Returns the number of energy equations associated with the mixture StateModel."
		    )

		.def("nMassEqns",
		    &Mutation::Mixture::nMassEqns,
		    "Returns the number of mass equations associated with the mixture StateModel."
		    )

		.def("hasElectrons",
		    &Mutation::Mixture::hasElectrons,
		    "Returns true if this mixture includes electrons, false otherwise."
		    )

		.def("setState",
		    &Mutation::Mixture::setState,
		    "Sets the state of the mixture using the StateModel belonging to the mixture."
		...
		.def("speciesName",
		    &Mutation::Mixture::speciesName,
		    "Returns the name of the species with the given index in the species array."
		    )

        .def("elementName",
		    &Mutation::Mixture::elementName,
		    "Returns the name of the element with the given index in the element array."
		    )

		.def("standardStateT",
		    &Mutation::Mixture::standardStateT,
		    "Returns the standard state temperature for the thermodynamic database begin used in K."
		    )

		.def("standardStateP",
		    &Mutation::Mixture::standardStateP,
		    "Returns the standard state pressure for the thermodynamic database being used in Pa."
		    )
		...
		.def("mixtureMwMass",
		    ...
		    "Returns the average molecular weight of the mixture given the species mass fractions."
		    )
		...
		.def("mixtureMwMole",
		    ...
		    "Returns the average molecular weight of the mixture given the species mole fractions."
		    )

		.def("mixtureMw",
		    &Mutation::Mixture::mixtureMw,
		...
		.def("speciesMw",
		    ...
		    "Returns the molecular weight in kg/mol of the species with the given index in the species array."
		    )

		.def("speciesMw",
		    [](const Mutation::Mixture &self)
		    {
                return self.speciesMw();
		    },
		    "Returns an array of the species molecular weight in kg/mol."
		    )

		.def("atomicMass",
		    &Mutation::Mixture::atomicMass,
		    "Returns the atomic weight in kg/mol of the element with the given index in the element array."
		    )

		.def("elementMatrix",
		    [](const Mutation::Mixture &self)
		    {
                return self.elementMatrix();
		    },
		    "* Returns the element matrix \f$ E_{i,j} \f$ in which the (i,j) component is equal to the"
		     "number of atoms of the jth element in one molecule of the ith species."
		    )

		.def("addComposition",
		    [](Mutation::Mixture &self, std::string mixture, bool add_composition)
		    {
		        self.addComposition(mixture.c_str(), add_composition);
		    },
		    "Add a named element composition to the mixture which may be retrieved with getComposition()."
		    )

		.def("getComposition_mass",
		    [](Mutation::Mixture &self, std::string mixture_composition)
		    {
		        std::vector<double> x_e(self.nElements());
		        self.getComposition(mixture_composition, x_e.data(), Mutation::Thermodynamics::Composition::MASS);
		        return x_e;
		    },
		    "Gets the element mass fractions associated with a named composition in the mixture."
		    )

		.def("getComposition_mole",
		    [](Mutation::Mixture &self, std::string mixture_composition)
		    {
		        std::vector<double> x_e(self.nElements());
		        self.getComposition(mixture_composition, x_e.data(), Mutation::Thermodynamics::Composition::MOLE);
		        return x_e;
		    },
		    "Gets the element mole fractions associated with a named composition in the mixture."
		    )


        .def("numberDensity",
		     static_cast<double (Mutation::Mixture::*)(const double, const double) const>(&Mutation::Mixture::numberDensity),
		    "Returns the number density of the mixture given the mixture temperature and pressure."
		    )

		.def("numberDensity",
		     static_cast<double (Mutation::Mixture::*)(void) const>(&Mutation::Mixture::numberDensity),
		    "Returns the current number density of the mixture."
		    )

        .def("pressure",
		    [](const Mutation::Mixture &self, const double T, const double P, const std::vector<double> Y)
		    {
		        return self.pressure(T, P, Y.data());
		    },
		    "Returns the pressure of the mixture in Pa given the mixture temperature and density and species mass fractions."
		    )

		.def("density",
		    [](const Mutation::Mixture &self, const double T, const double P, const std::vector<double> X)
		    {
		        return self.density(T, P, X.data());
		    },
		    "Returns the density of the mixture in kg/m^3 given the mixture temperature and pressure and species mole fractions."
		    )
		...
		.def("speciesCpOverR",
		    ...
		    "Returns the unitless vector of species specific heats at constant pressure \f$ C_{p,i} / R_u \f$."
		    )
		...
		.def("speciesCpOverR",
		    ...
		    "Returns the unitless vector of species specific heats at constant pressure "
		    "\f$ C_{p,i} / R_u \f$ given temperature in K."
		    )

		.def("mixtureFrozenCpMole",
		    &Mutation::Mixture::mixtureFrozenCpMole,
		    "Returns the frozen mixture averaged specific heat at constant pressure in J/mol-K."
		    )

		.def("mixtureFrozenCpMass",
		    &Mutation::Mixture::mixtureFrozenCpMass,
		    "Returns the frozen mixture averaged specific heat at constant pressure in J/kg-K."
		    )
		...
		.def("mixtureFrozenCvMole",
		    &Mutation::Mixture::mixtureFrozenCvMole,
		    "Returns the mixture averaged specific heat at constant volume in J/mol-K."
		    )

		.def("mixtureFrozenCvMass",
		    &Mutation::Mixture::mixtureFrozenCvMass,
		...
		.def("mixtureFrozenGamma",
		    &Mutation::Mixture::mixtureFrozenGamma,
		    "Returns the ratio of mixture averaged specific heats which is a unitless quantity."
		    )

		.def("mixtureEquilibriumGamma",
		    &Mutation::Mixture::mixtureFrozenGamma,
		    "Returns the current equilibrium ratio of mixture averaged specific heats which is a unitless quantity."
		    )
		...
		.def("Y",
		    [](const Mutation::Mixture &self)
		    {
                std::vector<double> x(self.Y(), self.Y() + self.nSpecies());
		        return x;
		    },
        ...
        .def("equilibriumComposition",
             [](const Mutation::Mixture &self, double T, double P, std::vector<double> xe)
		    {   std::vector<double> x (self.nSpecies());
        ...
        [](const Mutation::Mixture &self, double T, double P)
            ...
            "Equilibrates the mixture to the given temperature, pressure, and elemental mole fractions. "
            "If the mole fractions are not given, then the default fractions are used."
            )
        ...
        .def("mixtureHMole",
            static_cast<double (Mutation::Mixture::*)(void) const>(&Mutation::Mixture::mixtureHMole),
            "Returns the mixture averaged enthalpy in J/mol."
            )

        .def("mixtureHMole",
            static_cast<double (Mutation::Mixture::*)(double) const>(&Mutation::Mixture::mixtureHMole),
            "Returns the mixture averaged enthalpy in J/mol at the given temperature."
            )

        .def("mixtureHMass",
            static_cast<double (Mutation::Mixture::*)(void) const>(&Mutation::Mixture::mixtureHMass),
            "Returns the mixture averaged enthalpy in J/kg."
            )

        .def("mixtureHMass",
            static_cast<double (Mutation::Mixture::*)(double) const>(&Mutation::Mixture::mixtureHMass),
            "Returns the mixture averaged enthalpy in J/kg at the given temperature."
            )

        .def("mixtureHMinusH0Mass",
            &Mutation::Mixture::mixtureHMinusH0Mass,
            "Returns the mixture averaged enthalpy minus the enthalpy of the mixture at 0K with."
            )

        .def("mixtureEnergyMole",
            &Mutation::Mixture::mixtureEnergyMole,
            "Returns the mixture energy in J/mol."
            )

        .def("mixtureEnergyMass",
            &Mutation::Mixture::mixtureEnergyMass,
            "Returns the mixture energy in J/kg."
            )

        .def("frozenSoundSpeed",
            &Mutation::Mixture::frozenSoundSpeed,
            "Returns the frozen sound speed of the mixture in m/s."
            )

        .def("equilibriumSoundSpeed",
            &Mutation::Mixture::equilibriumSoundSpeed,
            "Returns the current equilibrium sound speed of the mixture in m/s."
            )

        .def("convert_rho_to_y",
            [](const Mutation::Mixture &self, std::vector<double> x)
            {
                std::vector<double> y(self.nSpecies());
                self.Mutation::Mixture::Thermodynamics::convert<Mutation::Thermodynamics::RHO_TO_Y>(x.data(),y.data());
                return y;
            },
            "Converts species densities to mass fraction."
            )

        .def("convert_rho_to_x",
            [](const Mutation::Mixture &self, std::vector<double> x)
            {
                std::vector<double> y(self.nSpecies());
                self.Mutation::Mixture::Thermodynamics::convert<Mutation::Thermodynamics::RHO_TO_X>(x.data(),y.data());
                return y;
            },
        ...
        .def("convert_y_to_x",
            ...
            {
                std::vector<double> y(self.nSpecies());
                self.Mutation::Mixture::Thermodynamics::convert<Mutation::Thermodynamics::Y_TO_X>(x.data(),y.data());
                return y;
            },
        ...
        .def("convert_x_to_y",
            ...
            {
                std::vector<double> y(self.nSpecies());
                self.Mutation::Mixture::Thermodynamics::convert<Mutation::Thermodynamics::X_TO_Y>(x.data(),y.data());
                return y;
            },
        ...
        .def("convert_x_to_xe",
            [](const Mutation::Mixture &self, std::vector<double> x)
            {
                ...
                self.Mutation::Mixture::Thermodynamics::convert<Mutation::Thermodynamics::X_TO_XE>(x.data(),y.data());
                return y;
            },
        ...
        .def("convert_y_to_ye",
            ...
            {
                std::vector<double> y(self.nElements());
                self.Mutation::Mixture::Thermodynamics::convert<Mutation::Thermodynamics::Y_TO_YE>(x.data(),y.data());
                return y;
            },
        ...
        .def("dRhodP",
			&Mutation::Mixture::dRhodP,
			"Returns the density derivative with respect to pressure for the current equilibrium state.")
		...
		.def("dXidT",
            ...
            "Returns the derivative of mole fraction w.t.r temperature for the given equilibrium mixture."
        ...
        .def("nReactions",
		    &Mutation::Mixture::nReactions,
		    "Returns the number of reactions in the mechanism."
		    )

		.def("forwardRateCoefficients",
        ...
        .def("forwardRatesOfProgress",
            ...
            "Fills the vector ropf with the forward rate of progress variables for each reaction."
            )

        .def("backwardRateCoefficients",
		    [](Mutation::Mixture &self)
            {
                std::vector<double> value(self.nReactions());
            ...
            "Fills the vector kb with the backward rate coefficients for each reaction."
            )

        .def("backwardRatesOfProgress",
		    [](Mutation::Mixture &self)
            {
                std::vector<double> value(self.nReactions());
            ...
            "Fills the vector ropb with the backward rates of progress variables for each reaction."
            )

        .def("netRatesOfProgress",
		    [](Mutation::Mixture &self)
            {
                std::vector<double> value(self.nReactions());
        ...
        .def("netProductionRates",
            ...
            "Fills the vector wdot with the net species production rates due to the chemical reactions."
            )

        .def("setViscosityAlgo",
                &Mutation::Mixture::setViscosityAlgo,
        ...
        .def("setDiffusionMatrixAlgo",
                &Mutation::Mixture::setDiffusionMatrixAlgo,
                "Sets the diffusion matrix algorithm."
            )

        .def("nCollisionPairs",
                &Mutation::Mixture::nCollisionPairs,
                "Returns the number of collision pairs accounted for in this mixture."
            )

        .def("viscosity",
                &Mutation::Mixture::viscosity,
        ...
        .def("frozenThermalConductivityVector",
		    [](Mutation::Mixture &self)
		    {
		    ...
		    "Returns the mixture thermal conductivity vector for a frozen mixture according to the state model."
		    )
        ...
        .def("equilibriumThermalConductivity",
                ...
                "Returns the mixture thermal conductivity for a mixture in thermochemical equilibrium"
            )
        ...
        .def("vibrationalThermalConductivity",
                ...
                "Returns the vibrattest_mixtureEquilibriumCvMassional energy thermal conductivity using Euken's formulas."
            )
        ...
        .def("butlerBrokawThermalConductivity",
                &Mutation::Mixture::reactiveThermalConductivity,
                "Returns the reactive thermal conductivity which accounts for reactions"
                " for mixtures in thermochemical equilibrium using the Butler-Brokaw formula."
            )

        .def("soretThermalConductivity",
                &Mutation::Mixture::soretThermalConductivity,
                "Returns the Soret thermal conductivity the mixture in thermochemical"
                " equilibrium."
            )

       .def("heavyThermalDiffusionRatios",
             [](Mutation::Mixture &self)
		    {
       ...
       .def("diffusionMatrix",
		    [](Mutation::Mixture &self)
		    {
                return self.diffusionMatrix();
		    },
		    "Returns the multicomponent diffusion coefficient matrix."
		    )

       .def("meanFreePath",
                &Mutation::Mixture::meanFreePath,
                "Mean free path of the mixture in m."
            )


       .def("electronMeanFreePath",
                &Mutation::Mixture::electronMeanFreePath,
                "Mean free path of electrons in m."
            )

       .def("speciesThermalSpeed",
                &Mutation::Mixture::speciesThermalSpeed,
       ...
       .def("electronThermalSpeed",
                &Mutation::Mixture::electronThermalSpeed,
       ...
       .def("electricConductivity",
                &Mutation::Mixture::electricConductivity,
       ...
       .def("stefanMaxwell",
            [](Mutation::Mixture &self, std::vector<double> grad_x)
            {
                ...
                self.stefanMaxwell(grad_x.data(), diff_velocities.data(), electricField);
