...
public:
    SurfaceProductionRate( ARGS l_data_wall_prod_terms )
        ...
        DataGSIReaction l_data_gsi_reaction = { l_data_wall_prod_terms.s_thermo } ;
        ...
        DataGSIRateManager l_data_rate_manager = { l_data_wall_prod_terms.s_thermo, l_data_wall_prod_terms.s_surf_descr, v_reaction };
