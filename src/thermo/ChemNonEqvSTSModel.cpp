/**
 * @file ChemNonEqvSTSModel.h
 *
 * @brief Provides ChemNonEqvSTSModel.
 */
 ...
 */
class ChemNonEqvSTSModel : public StateModel
{
public:

    ChemNonEqvSTSModel(const Thermodynamics& thermo)
        ...
        const int vars = 0)
    {
        ...
        default:
            throw InvalidInputError("variable set", vars)
                << "This variable-set is not implemented in ChemNonEqvSTSModel"
...
}; // class ChemNonEqvSTSModel

// Register the state model
Utilities::Config::ObjectProvider<
    ChemNonEqvSTSModel, StateModel> chem_non_eq_vSTS("ChemNonEqvSTS");
