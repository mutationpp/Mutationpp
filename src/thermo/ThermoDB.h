...
public:
    ...
    /**
     * Computes the unitless species specific heats \f$ C_{p,i}/R_U\f$ of each
     * species in thermal nonequilibrium.
     *
     ...
     * @param cp   - on return, the array of species non-dimensional cp
